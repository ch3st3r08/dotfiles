...
systemctl is-active --quiet sddm || sudo systemctl enable sddm.service

echo "Nota: Activar avahi-daemon y geoclue"
echo "Nota: Run /usr/lib/geoclue-2.0/demos/agent"
...
echo "Nota: Recuerda aplicar el tema de plymouth [plymouth-set-default-theme tema]"
echo "Nota: Los temas de grub hay que copiarlos a la ruta /boot/grub/themes"
echo "--------------------------------------------------"
